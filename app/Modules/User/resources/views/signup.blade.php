...
<head>
    <meta charset="utf-8"/>
    <title>Sign Up | Batman</title>


    <meta name="description" content="Image Creative Education"/>
...
<div class="app">
    <div class="center-block w-xxl w-auto-xs p-v-md">
        <div class="navbar">
            <div class="navbar-brand m-t-lg text-center"><br>
                <a href='/'>
                <img src="/assets/images/batman-logo.png">
			</a>
            </div>
        </div>
        ...
        <form id="signupForm" action="/user/sign-up" method="post">
            ...
            <div class="p-lg panel md-whiteframe-z1 text-color m">
                @if(isset($error))
                    <div id="alert-message" class="alert alert-danger">{{ $error}}</div>
                @endif
                @if(isset($success))
                    <div id="alert-message" class="alert alert-success">{{ $success}}</div>
                @endif
                <div class="md-form-group float-label">
                    <input type="text" class="md-input validate[required]" id="name" name="name"
                           data-prompt-position="centerRight" ng-model="user.name">
                    <label>Name</label>
                </div>
                <div class="md-form-group float-label">
                ...
                <button md-ink-ripple type="submit" id="mybutton" style="background:  dodgerblue; color: white; "
                        class="md-btn md-raised  btn-block p-h-md">Sign Up
                </button>
				<div>
		<p>Already have account? <a href="/user/login">Login</a></p>
	</div>
